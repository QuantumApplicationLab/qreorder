...
# install qreorder as an editable package
...
The second is to use `tox`, which can be installed separately (e.g. with `pip install tox`), i.e. not necessarily inside the virtual environment you use for installing `qreorder`, but then builds the necessary virtual environments itself by simply running:
...
cd $(mktemp -d qreorder.XXXXXX)
git clone git@github.com:QuantumApplicationLab/qreorder .
...
Visit
[https://test.pypi.org/project/qreorder](https://test.pypi.org/project/qreorder)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d qreorder-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple qreorder
```
...
Don't forget to also make a [release on GitHub](https://github.com/QuantumApplicationLab/qreorder/releases/new). If your repository uses the GitHub-Zenodo integration this will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.
